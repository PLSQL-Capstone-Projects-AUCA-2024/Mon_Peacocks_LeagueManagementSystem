...
###Primary Keys: Match_ID, Team_ID,Player_ID,Season_ID, Stadium_ID,Coach_ID, TeamPlayer_ID, Transfer_ID  ###Foreign Keys:FK_MATCH_AWAY_TEAM,FK_MATCH_HOME_TEAM,FK_TEAM_COACH etc.
